...
function orcaApiSwapSell(path, ammount) {
    ...
    return new Promise(function (resolve, reject) {
        var main = function () { return __awaiter(_this, void 0, void 0, function () {
            var secretKeyString, secretKey, owner, connection, orca, orcaUsdcPool, orcaToken, orcaAmount, quote, usdcAmount, swapPayload, swapTxId, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        orcaToken = orcaUsdcPool.getTokenA();
                        orcaAmount = new decimal_js_1.default(ammount);
                        return [4 /*yield*/, orcaUsdcPool.getQuote(orcaToken, orcaAmount)];
                    case 2:
                        quote = _a.sent();
                        usdcAmount = quote.getMinOutputAmount();
                        console.log("Swap " + orcaAmount.toString() + " orca for at least " + usdcAmount.toNumber() + " usdc");
                        return [4 /*yield*/, orcaUsdcPool.swap(owner, orcaToken, orcaAmount, usdcAmount)];
                    case 3:
                        swapPayload = _a.sent();
